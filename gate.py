...
k("G15","이벤트 스트레스 테스트 코너 노출",
  hz("이벤트 스트레스 테스트") and hz("총자산 대비"))
k("G15","헤지 유효성 코너 노출",
  hz("헤지 유효성") and hz("반도체 대비"))
...
if _P.get("ok"):
    ...
    k("G12","3구간(20/60/120) 샤프·변동성·베타 실측", h("샤프지수") and h("베타(β)") and h("초과 위험 배수") and h("소르티노"))
